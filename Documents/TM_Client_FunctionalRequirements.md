...
- **FR1.4** A **More actions** menu in the header holds secondary actions. (No separate Configuration File tab.) It currently holds **Download configuration file** (FR15.5) and **Upload configuration file** (FR15.11). Import / export of the encoded config file (US14) is **parked pending Product confirmation** and is not offered meanwhile.
